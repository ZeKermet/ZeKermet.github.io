...
pageFooter.innerHTML += `
    <div class="section-container footer">
        <div class="footer-logo">
            <p>Site Created By</p>
            <h4 class="secondary-font">ZK Aviation</h4>
        </div>
        ...
        <div class="footer-pages">
            <nav id="navlinks-footer">
                <ul>
                    ...
                    <a href="articles.html"><li class="navlink">Articles</li></a>
        ...
        <div class="socials-buttons">
            <a href="${GeneralLinks.getYoutubeChannel()}" target="_blank" rel="noopener noreferrer">
